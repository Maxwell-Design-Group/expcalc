...
class EditClientDetail extends Component {
    ...
    componentDidMount = () => {
        axios.get('http://localhost:4200/clientdetails/edit/'+this.props.match.params.id)
        .then((response) => {
            this.setState({
                value: response.data
            })
        ...
        axios.get('http://localhost:4200/contracttypelists/')
        .then((response) => {
            // this.setState({
        ...
        axios.get('http://localhost:4200/industrytypes/')
        .then((response) => {
            // this.setState({
